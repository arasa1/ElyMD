...
async function addExif(webpSticker, packname, author, categories = [], extra = {}) {
	...
	const json = { 'sticker-pack-id': stickerPackId, 'sticker-pack-name': packname, 'sticker-pack-publisher': author, 'emojis': categories, 'link-group-bot': 'https://tinyurl.com/azamilaifu2', 'link-script-github': 'https://github.com/clicknetcafe/azamibot-md-multi', ...extra };
